...
class HelpdeskTicket(models.Model):
    ...
    def message_post(self, *,
        ...
        message = super(HelpdeskTicket, self).message_post(body=body, subject=subject, message_type=message_type,
                     ...
                     **kwargs)
        if  self._is_user_from_frontend() and bool(message_type == 'comment') and bool(subtype=='mail.mt_comment' or subtype=='mt_comment') and self.stage_id.flag_before_email:
